...
using CoreApp.Areas.App.Models.AccountViewModels;
...
namespace CoreApp.Areas.Admin.Controllers
{
    public class AccountController : BaseAppController
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, ILogger<AccountController> logger) : base(logger)
        {
